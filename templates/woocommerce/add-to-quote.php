...
<div
    ...
    ?>
<div
		class="yith_ywraq_add_item_browse-list-<?php echo esc_attr( $product_id ); ?> yith_ywraq_add_item_browse_message gqs-continue-shopping gm-continue-shopping gl-continue-shopping <?php echo esc_attr( ( ! $exists ) ? 'hide' : 'show' ); ?> hide-when-removed"
